const StampStar = () => (
  ...
  >
    <g transform="translate(40, 20)">
      ...
      <circle cx="45" cy="73" r="4" fill="#2C3E50" />
      <circle cx="55" cy="73" r="4" fill="#2C3E50" />
      <circle cx="46" cy="72" r="1.5" fill="#FFFFFF" />
      <circle cx="56" cy="72" r="1.5" fill="#FFFFFF" />

      <path d="M 45 78 Q 50 82 55 78" stroke="#2C3E50" strokeWidth="2" fill="none" strokeLinecap="round" />
      ...
      <rect x="8" y="85" width="28" height="38" fill="#FFFEF0" stroke="#D4AF37" strokeWidth="2" rx="2" />
      <line x1="12" y1="92" x2="32" y2="92" stroke="#E0D4A0" strokeWidth="1" />
      <line x1="12" y1="97" x2="32" y2="97" stroke="#E0D4A0" strokeWidth="1" />
      <line x1="12" y1="102" x2="32" y2="102" stroke="#E0D4A0" strokeWidth="1" />
      <line x1="12" y1="107" x2="32" y2="107" stroke="#E0D4A0" strokeWidth="1" />
      <text x="14" y="95" fontSize="8" fill="#888" fontFamily="Arial, sans-serif">PERMIT</text>

      <circle cx="22" cy="112" r="8" fill="#4CAF50" opacity="0.2" />
      <path d="M 18 112 L 21 116 L 27 108" stroke="#4CAF50" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <text x="13" y="119" fontSize="6" fill="#4CAF50" fontWeight="bold" fontFamily="Arial, sans-serif">APPROVED</text>

      <line x1="32" y1="102" x2="35" y2="105" stroke="#FFAA88" strokeWidth="4" strokeLinecap="round" />
      <ellipse cx="35" cy="107" rx="3" ry="4" fill="#FFAA88" />
      <ellipse cx="35" cy="107" rx="2.5" ry="3.5" fill="#FF9966" />
    </g>
  </svg>
);
